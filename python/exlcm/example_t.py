...
class example_t(object):
    ...
    def __init__(self):
        self.timestamp = 0
        self.position = [ 0.0 for dim0 in range(1000000) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>1000000d', *self.position[:1000000]))
    ...
    def _decode_one(buf):
        ...
        self.position = struct.unpack('>1000000d', buf.read(8000000))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6e5dc379c6269be1) & 0xffffffffffffffff
