...
class HttpWSSProtocol(websockets.WebSocketServerProtocol):
    ...
    async def handler(self):
        print("request")
        # print(await websockets.http.read_request(self.reader))
        ...
        super.writer.write(response.encode())
        self.writer.close()
        print("end")
...
# port = int(os.getenv('PORT', 8765))#5687
start_server = websockets.serve(ws_handler, '127.0.0.1', 8765, klass=HttpWSSProtocol)
